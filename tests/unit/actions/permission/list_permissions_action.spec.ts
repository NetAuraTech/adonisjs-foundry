...
import { ListPermissionsAction } from '#actions/permission/list_permissions_action'
import Permission from '#models/auth/permission'

test.group('ListPermissionsAction', () => {
  test('execute() returns paginated permissions with optional search filter', async ({
    assert,
  }) => {

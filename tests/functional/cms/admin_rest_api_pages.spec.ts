...
test.group('Admin REST API v1 — Pages', (group) => {
  ...
  test('list filters by locale', async ({ client, assert }) => {
    ...
    const res = await client
      .get('/api/v1/admin/pages?locale=fr')
      .accept('json')
      .bearerToken(token.value!.release())
  ...
  test('shows a page by id', async ({ client, assert }) => {
    ...
    const res = await client
      .get(`/api/v1/admin/pages/${page.id}`)
      .accept('json')
      .bearerToken(token.value!.release())
  ...
  test('delete returns 404 for an unknown id', async ({ client }) => {
    ...
    const res = await client
      .delete('/api/v1/admin/pages/999999')
      .accept('json')
      .bearerToken(token.value!.release())
  ...
  test('restores a revision', async ({ client, assert }) => {
    ...
    const res = await client
      .post(
        `/api/v1/admin/pages/${pageId}/translations/${translation.id}/revisions/${revisionId}/restore`
      )
      .accept('json')
      .bearerToken(token.value!.release())
  ...
  test('restore revision returns 404 for unknown revision', async ({ client }) => {
    ...
    const res = await client
      .post(
        `/api/v1/admin/pages/${page.id}/translations/${translation.id}/revisions/999999/restore`
      )
      .accept('json')
      .bearerToken(token.value!.release())
  ...
  test('toggles revision keep (pin) state', async ({ client, assert }) => {
    ...
    const res = await client
      .put(
        `/api/v1/admin/pages/${pageId}/translations/${translation.id}/revisions/${revisionId}/pin`
      )
      .accept('json')
      .bearerToken(token.value!.release())

    ...
    >
            ...
            <div className="grid gap-6">
              ...
              <div className="grid gap-1.5">
                ...
                <ImagePicker
                  ...
                  onChange={(event) =>
                    setThumbnailId(event.target.value ? Number(event.target.value) : null)
                  }
                />
                <div className="flex items-center gap-2 mt-1">
                  ...
                  >
                    ...
                    {regenerating
                      ? t('form.thumbnail.regenerating')
                      : t('form.thumbnail.regenerate')}
                  </Button>
                  <Button
                    type="button"
                    variant="icon_danger"
      ...
      <Card title={t('preview.value')}>
        ...
        <TemplateContentPreview
          content={template.content as PageContent}
    ...
    <div className={depth > 0 ? 'ml-4 pl-2 border-l border-edge/50' : ''}>
      ...
      {hasChildren &&
        block.children!.map((child) => (
          <BlockPreview key={child.id} block={child} depth={depth + 1} />
        ))}
    </div>
  )
}

...
import type { CmsRolesShowTranslations } from '#types/translations'
import { Form } from '@adonisjs/inertia/react'
import { SharedProps } from '@adonisjs/inertia/types'

type PageProps = {
  role: Data.Role
  translations: CmsRolesShowTranslations
}
              ...
              <div className="flex gap-3">
                ...
                <CanAccess permission="roles.delete">
                  ...
                  >
                    <Button
                      variant="icon_danger"
                      title={t('actions.delete', { name: roleName })}
                      fitContent
                    >
                ...
                {(role.users ?? []).length === 0 ? (
                  ...
                  (role.users ?? []).map((user) => (
                    <Table.Row key={`user-${user.id}`}>
                      <Table.Cell data-label={t('users.table.username')}>
                        {user.username}
                      </Table.Cell>

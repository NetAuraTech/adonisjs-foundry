...
export const rules = {
	 ...
	 */
	custom: (validator: (value: any) => boolean, i18nKey: string): LazyValidationRule => createRule(validator, i18nKey),
...
export const presets = {
	...
	password: (fieldNameKey?: string) => [rules.required(fieldNameKey), rules.minLength(8, fieldNameKey)],
	passwordConfirmation: (passwordToMatch: string, fieldNameKeyRequired?: string, fieldNameKeyMatch?: string) => [
		rules.required(fieldNameKeyRequired),
		rules.matches(passwordToMatch, fieldNameKeyMatch),
	],

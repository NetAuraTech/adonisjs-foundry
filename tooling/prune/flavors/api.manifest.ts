	...
	rewrites: [
		...
		// ─── apps/web/package.json — drop the front script + the prune alias ───
		{
			...
			content: [
				...
				'  "type": "module",',
				'  "imports": {',
				'    "#transport/account/*": "./app/account/*.js",',
				'    "#transport/auth/*": "./app/auth/*.js",',
				'    "#transport/core/*": "./app/core/*.js",',
				'    "#transport/file/*": "./app/file/*.js",',
				'    "#transport/identity/*": "./app/identity/*.js",',
				'    "#transport/log/*": "./app/log/*.js",',

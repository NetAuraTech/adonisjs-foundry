...
const inertiaManifest: FlavorManifest = {
	...
	rewrites: [
		...
		// ─── start/routes.ts — drop the CMS, register the core home ────────────
		{
		...
		// ─── package.json (root) — monorepo scripts, typecheck without the root tsc ───
		{
			...
			content: [
				...
				'    "typecheck": "tsc --noEmit -p apps/web/tsconfig.json && tsc --noEmit -p apps/web/inertia/tsconfig.json && npm run typecheck --workspace @foundry/design-system",',

 ...
 * file. The REST contract lives in exactly one directory (`app/http/rest/`),
...
/**
 * Find the `#rest/<name>_resource` import specifier of a resource variable
 * inside a controller source.
 *

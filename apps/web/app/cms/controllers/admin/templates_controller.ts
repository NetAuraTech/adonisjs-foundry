...
export default class TemplatesController {
	...
	async execute(ctx: HttpContext) {
		...
		session.flash('success', this.i18n.translate('cms.template.created'));

		return response.redirect().toRoute('admin.cms.templates.render');
	}
	...
	async update(ctx: HttpContext) {
		...
		session.flash('success', this.i18n.translate('cms.template.updated'));
	...
	async destroy(ctx: HttpContext) {
		...
		session.flash('success', this.i18n.translate('cms.template.deleted'));
	...
	async applyToPage(ctx: HttpContext) {
		...
		session.flash('success', this.i18n.translate('cms.template.applied'));

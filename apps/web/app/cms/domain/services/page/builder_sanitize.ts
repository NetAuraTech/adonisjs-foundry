import { sanitizePageContent, purify, PURIFY_CONFIG } from '#cms/domain/services/page/sanitize_content';
 ...
 */
export function sanitizeBuilderOperation(op: string, payload: Record<string, unknown>): Record<string, unknown> {
	switch (op) {
		case 'UPDATE_PROPS': {
 ...
 */
const RICH_TEXT_FIELDS = ['text', 'content', 'html', 'label', 'placeholder', 'helpText', 'caption', 'attribution'];

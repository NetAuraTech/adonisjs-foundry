		...
		<footer className="bg-primary-deep px-6 md:px-16 pt-14 pb-8">
			<div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 pb-10 mb-8 border-b border-primary">
				<div className="col-span-2 md:col-span-1">
					<Link href="/" className="text-ink-inverted font-semibold tracking-wide text-xl font-cormorant">
						{pageProps.app_name}
					</Link>
					<Paragraph
					...
					>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aut culpa cupiditate dignissimos
						distinctio, doloribus et harum id impedit ipsa laboriosam laudantium modi numquam obcaecati omnis, quisquam
						quod sint ullam!
					</Paragraph>
				</div>

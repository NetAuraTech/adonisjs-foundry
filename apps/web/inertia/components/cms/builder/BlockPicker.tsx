...
const ICONS: Record<string, React.ReactNode> = {
	...
	'align-left': (
		<>
			<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 6h16M4 10h12M4 14h16M4 18h12" />
		</>
	),
	image: (
		<>
	...
	'mouse-pointer': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 4l7 18 2-7 7-2L4 4z" />,
	...
	video: (
		<>
			...
			<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 10l6-3v10l-6-3z" />
		</>
	),
	carousel: (
		<>
	...
	list: (
		<>
			<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 6h12M9 12h12M9 18h12" />
				...
				{filteredBlocks.map((block) => (
					...
					>
						...
						<div className="min-w-0">
							...
							<p className="text-xs text-ink-subtle mt-0.5 leading-tight line-clamp-2">{block.description}</p>
						</div>
					</button>
				))}
			</div>
